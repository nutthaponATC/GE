...
<body>
	...
	<div style="width:80%; height:100%; left:20%; float:left;  position:relative;">
		<div id="info1" class="container">
			<form action="add_info3.php" method="post">
				<h3>เพิ่มข้อมูลจดหมายข่าว</h3>
				<br>
				<h4>หัวข้อจดหมายข่าว</h4><input class="form-control" type="text" name="header">
		        ...
		        <tbody>
		        	...
		        	while ($data = mysql_fetch_array($query)) {
		        		...
		        		<tr style='cursor:pointer;' data-href='edit3.php?id_info=".$data['id_info']."'>
			                ...
			                <td><center><a href='edit3.php?id_info=".$data['id_info']."'><i class='fa fa-cog' style='color:#b45564; font-size:30px;' aria-hidden='true'></i></a></center></td>
				            <td><center><a href='remove3.php?id_info=".$data['id_info']."'><i class='fa fa-times' style='color:#b45564; font-size:30px;' aria-hidden='true'></a></i></center></td>
			            </tr>";
		        	}
		        	 ?>
