	...
	<div style="width:80%; height:100%; left:20%; float:left;  position:relative;">
		<div id="info1" class="container">
			<form action="add_info2.php" method="post">
				...
				<br>
				<h4>หัวข้อข่าวสัมมนา</h4><input class="form-control" type="text" name="header">
				<h4>รายละเอียดข่าวสัมมนา</h4>
			...
			<table id="example" class="display" style="font-size: 15px; padding-top:30px;" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		                <th width="170"><center>หัวข้อข่าวสัมมนา</center></th>
		                <th><center>รายละเอียดข่าวสัมมนา</center></th>
		        ...
		        <tbody>
		        	...
		        	while ($data = mysql_fetch_array($query)) {
		        		echo "
		        		<tr style='cursor:pointer;' data-href='edit2.php?id_info=".$data['id_info']."'>
			                <td>".$data['header']."</td>
			                <td>".$data['detail']."</td>
			                <td><center>".$data['date']."</center></td>
			                <td><center><a href='edit2.php?id_info=".$data['id_info']."'><i class='fa fa-cog' style='color:#b45564; font-size:30px;' aria-hidden='true'></i></a></center></td>
				            <td><center><a href='remove2.php?id_info=".$data['id_info']."'><i class='fa fa-times' style='color:#b45564; font-size:30px;' aria-hidden='true'></a></i></center></td>
			            </tr>";
		        	}
		        	 ?>
