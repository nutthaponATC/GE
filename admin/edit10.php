...
<body>
	...
	<div style="width:80%; height:100%; left:20%; float:left;  position:relative;">
		<div id="info1" class="container">
			<form action="edit_process10.php" method="post" enctype="multipart/form-data">
				<?php 
				...
				<br>
				<h4>หัวข้อแบบฟอร์มสำหรับ นักศึกษา</h4><input class="form-control" type="text" name="header" value="<?php echo $data['title']; ?>">
				...
				<a href="remove10.php?id_public=<?php echo $data['id_public']; ?>"><input id="bt" class="btn btn-default" style="margin-top:10px; background-color:b45564; color:white;" type="button" name="delete" value="ลบ"></a>
			</form>
