...
<body>
	<div class="container container-table">
	    <div class="row vertical-center-row">
	    	<center><h2 style="font-size: 450%; font-style: italic; color: #be6a77;">สำนักศึกษาทั่วไป</h2></center>
	        <div class="text-center col-md-4 col-md-offset-4" style="background-color: #be6a77; color:#ffffff; padding-top:40px; padding-bottom:40px; border-radius: 25px;">
